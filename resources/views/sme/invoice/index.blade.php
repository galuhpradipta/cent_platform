    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card data-tables">
                <div class="card-body able-striped table-no-bordered table-hover dataTable dtr-inline table-full-width">
                    <div class="col-sm-6 col-lg-3">                                
                        <form action="{{ route('sme-invoice.create') }}">
                            <input type="submit" class="btn btn-wd btn-success" value="Buat Invoice">
                        </form>
                    </div>
