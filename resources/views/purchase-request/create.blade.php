        ...
        <div class="card">
            <div class="card-title">
                <div class="row">
                    <div class="col-md-4 ml-5">
                        <h4 class="modal-title"><strong>Buat Pesanan Pembelian Baru</strong></h4>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <hr class="sidebar-divider">
                    <form action="{{ route('pr.store')}}" method="POST" enctype="multipart/form-data" id="soForm">
                        @csrf
                        <div class="body">                            
                            <div class="form-row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="supplier_email" placeholder="ID Supplier" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="supplier_phone" placeholder="Nomor Telpon Supplier" readonly>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $('#supplier_id').on('change', function() {
      ...
      $.get(baseURL+'/api/supplier/'+supplierID, function(data,status) {
        ...
        $('#supplier_phone').val(data.phone_number);
      });
    });
